window.onload = function() {
    ...
    let displayPath = "/blog/displayEntry.php?entry=";
    ...
    req.open("GET", "/blog/getEntries.php");
    req.send();
    ...
    function entriesLoaded() {
        ...
        console.log("There are " + entries.length + " posts on this page.")
        document.querySelector(".siteStats").innerHTML += "n" +  entries.length;
    ...
    // Produce link for image 1 - 560 in allPng directory
    let rndm = Math.floor((Math.random() * 560) + 1);
    let rndmPng = "/siteImages/allPngs/" + rndm + ".png";
    ...
    function formatMain(entry) {
        ...
        link.setAttribute("class", "entryData entryName eachWord");
