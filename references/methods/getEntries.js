window.onload = function() {
    ...
    let displayPath = "/references/methods/displayEntry.php?entry=";
    ...
    if(mainE) {
        ...
        mainEntries.onclick = function(e) {
            if(e.target.dataset.entry !== undefined) { //Check if target is a link (a tag) by checking if it has the property 'data-entry', as only links (a tags) have this property in the entries div
                window.location.href = "/references/methods/displayEntry.php?entry=" + e.target.dataset.entry;
            }
        }
    }
    ...
    if(sideE) {
        ...
        sideEntries.onclick = function(e) {
            if(e.target.parentNode.dataset.entry !== undefined) {
                console.log("yeet");
                window.location.href = "/references/methods/displayEntry.php?entry=" + e.target.parentNode.dataset.entry;
            }
        }
    }
    ...
    req.open("GET", "/references/methods/getEntries.php");
    req.send();
